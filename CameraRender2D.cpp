    ...
    void CameraRender2D::DisplayEdges(Mesh& m, const Affine& A, const Vector& color) {
        ...
        for (int j = 0; j < eCount; ++j) {
            ...
            p1_ndc.x /= p1_ndc.w; p1_ndc.y /= p1_ndc.w; p1_ndc.z /= p1_ndc.w;
            p2_ndc.x /= p2_ndc.w; p2_ndc.y /= p2_ndc.w; p2_ndc.z /= p2_ndc.w;
            p1_ndc.w = 1.0f;
            p2_ndc.w = 1.0f;
    ...
    void CameraRender2D::DisplayFaces(Mesh& m, const Affine& A, const Vector& color) {
        ...
        for (int k = 0; k < fCount; ++k) {
            ...
            p1_ndc.x /= p1_ndc.w; p1_ndc.y /= p1_ndc.w; p1_ndc.z /= p1_ndc.w;
            p2_ndc.x /= p2_ndc.w; p2_ndc.y /= p2_ndc.w; p2_ndc.z /= p2_ndc.w;
            p3_ndc.x /= p3_ndc.w; p3_ndc.y /= p3_ndc.w; p3_ndc.z /= p3_ndc.w;
